    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            >
                ...
                >
                    <Tab.Screen name={t("Yesterday")} component={YesterdayPachange} />
                    <Tab.Screen name={t("Today")} component={TodayPanchange} />
                    <Tab.Screen name={t("Tomorrow")} component={TommorowPanchang} />
                </Tab.Navigator>
            </View>
        </View>
    );
