        ...
        case actionTypes.SET_CHAT_CALL_DATA_SAVE:
            ...
            case actionTypes.SET_ON_VIDEO_CALL_END:
                ...
                case actionTypes.SET_VIDEO_INVOICE_DATA:
                    ...
                    case actionTypes.SET_CAMERA_VISION_VISIBLE:
                        return {
                            ...state,
                            cameraVisionVisible: payload
                        }
                     case actionTypes.SET_CHAT_REPLAY:
            return {
                ...state,
                chatReplay: payload
            }
             case actionTypes.SET_NEW_LINKED_DATA:
            return {
                ...state,
                linkedData: payload
            }
