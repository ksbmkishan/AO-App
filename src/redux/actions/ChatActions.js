...
export const setCameraVisionVisible = payload => ({
    type: actionTypes.SET_CAMERA_VISION_VISIBLE,
    payload,
})

export const setChatReplay = payload => ({
    type: actionTypes.SET_CHAT_REPLAY,
    payload
})
