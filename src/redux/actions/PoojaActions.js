...
export const getAllReligionCollection = payload =>({
    type : actionTypes.GET_ALL_RELIGION_COLLECTION,
    payload
})

export const setAllReligionCollection = payload =>({
    type : actionTypes.SET_ALL_RELIGION_COLLECTION,
    payload
})


export const getAllReligionCollectionSubCategory = payload =>({
    type : actionTypes.GET_ALL_RELIGION_COLLECTION_SUB_CATGORY,
    payload
})

export const setAllReligionCollectionSubCategory = payload =>({
    type : actionTypes.SET_ALL_RELIGION_COLLECTION_SUB_CATGORY,
    payload
})
