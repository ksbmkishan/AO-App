      ...
      >
        <TouchableOpacity
          ...
          <View
            ...
            <Image source={{ uri: photo }} style={{ height: height * 0.8, width: width * 0.8, borderRadius: 10, margin: 10,alignSelf:'center' }} />
  ...
  function NoDATA() {
    return (
      <View style={{ justifyContent: 'center', alignItems: "center", paddingVertical: SCREEN_HEIGHT * 0.35 }}>
        <Text style={{ ...Fonts.black11InterMedium, fontSize: 17 }}>No tutorials  Found</Text>
    ...
    const renderItem = ({ item, index }) => {
      ...
      return (
        <TouchableOpacity
          ...
          <Image source={{ uri: base_url + item?.image }} style={{ height: height * 0.4, width: width * 0.4, borderRadius: 10, margin: 10, alignSelf:'center'}} />
