...
const Bell = ({ dispatch, gifBellVisible, imageBellVisible, imageBellVisible1, gifBellVisible1, bellSound, bellSound2 }) => {
  ...
  return (
    <View style={{ zIndex: 2, right: 0, left: 0, flexDirection: 'row', position: 'absolute', top: SCREEN_HEIGHT * 0.33, alignSelf: 'center', justifyContent: 'space-between', overflow: 'hidden',paddingHorizontal:60 }}
    ...
    >
      ...
      <TouchableOpacity
        ...
        style={{
          ...
          // left: gifBellVisible ? SCREEN_WIDTH * 0.22 : SCREEN_WIDTH * 0.22,
          zIndex: 1,
        }}
