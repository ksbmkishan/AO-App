...
const KundliBirthTime = ({ navigation, kundlidob, dispatch }) => {
    ...
    const handleNext = () => {
        dispatch(SettingActions.setTime(date));
        navigation.navigate('KundliBirthPlace');
    };
    return (
        ...
        return (
            <View>
                <Text style={{
                    ...
                    textAlign: 'center',
                    fontSize: 26,
                }}> <TranslateText title={'What is Your Birth Time'}/></Text>
            </View>
        )
    }
    function dataModal() {
...
export default connect(mapStateToProps, mapDispatchToProps)(KundliBirthTime);
