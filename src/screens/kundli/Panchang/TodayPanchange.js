...
const TodayPanchange = ({ dispatch, NewPanchang, isLoading }) => {
    ...
    useEffect(() => {
        dispatch(KundliActions.getMyPanchang());
    }, []);

    const p = NewPanchang?.panchang;
...
export default connect(mapStateToProps, mapDispatchToProps)(TodayPanchange);
