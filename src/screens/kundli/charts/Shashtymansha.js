...
const Shashtymansha = ({ basicDetails, dispatch, ShashtymanshaChart , isLoading}) => {

    console.log("arpit", ShashtymanshaChart)
    ...
    useEffect(() => {
        ...
        dispatch(KundliActions.getShashtymanshaChart(payload))
    }, [dispatch])

   if (isLoading || !ShashtymanshaChart) {
              return <Loader  />;
          }
    ...
    return (
        <View>
            ...
            <View style={{paddingVertical:SCREEN_HEIGHT*0.03}}>
                <ChartSvg data={ShashtymanshaChart} />
            </View>
...
const mapStateToProps = state => ({
    ...
    ShashtymanshaChart: state.kundli.ShashtymanshaChart,
...
export default connect(mapStateToProps, mapDispatchToProps)(Shashtymansha);
