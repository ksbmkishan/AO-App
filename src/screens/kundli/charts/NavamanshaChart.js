...
const NavamanshaChart = ({ basicDetails, dispatch, Navamanshachart,isLoading }) => {

    console.log("arpit", JSON.stringify(Navamanshachart))
    ...
    useEffect(() => {
        ...
        dispatch(KundliActions.getNavamanshaChart(payload))
    }, [dispatch])



      if (isLoading || !Navamanshachart) {
              return <Loader />;
          }
...
export default connect(mapStateToProps, mapDispatchToProps)(NavamanshaChart);
