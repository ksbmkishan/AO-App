...
const DashamanshaChart = ({ basicDetails, dispatch, DashaManshaChart,isLoading }) => {

    console.log("arpit", DashaManshaChart)
    ...
    useEffect(() => {
        ...
        dispatch(KundliActions.getDashamanshaChart(payload))
    }, [dispatch])

    if (isLoading || !DashaManshaChart) {
              return <Loader  />;
          }
    ...
    return (
        <View>
            ...
            <View style={{paddingVertical:SCREEN_HEIGHT*0.03}}>
                <ChartSvg data={DashaManshaChart} />
            </View>
...
const mapStateToProps = state => ({
    ...
    DashaManshaChart: state.kundli.DashaManshaChart,
...
export default connect(mapStateToProps, mapDispatchToProps)(DashamanshaChart);
