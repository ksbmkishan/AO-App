...
const MoonChart = ({ basicDetails, dispatch, MoonChart,isLoading }) => {

    console.log("arpit", MoonChart)
    ...
    useEffect(() => {
        ...
        dispatch(KundliActions.getMoon2Chart(payload))
    }, [dispatch])


    

        if (isLoading || !MoonChart) {
              return <Loader />;
          }
