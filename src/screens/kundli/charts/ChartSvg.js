        ...
        <View style={{ flex: 0, justifyContent: 'center', alignItems: 'center' }}>
            {data &&  <Svg 
                    ...
                    <G x="-82" y="-210">
                        ...
                        <Text color="black" fill="green" fontWeight={"500"} fontSize="12" x="249.25" y="245.1">
                    ...
                    <G x="-235" y="-210">
                        ...
                        <Text color="black" fill="blue" fontWeight={"500"} fontSize="12" x="252.25" y="345.1">
                    ...
                    <G x="-165" y="-125">
                        ...
                        <Text color="black" fill="blue" fontWeight={"500"} fontSize="12" x="210.25" y="310.1">
                    ...
                    <G x="-235" y="-70">
                        ...
                        <Text color="black" fill="red" fontWeight={"500"} fontSize="12" x="257.25" y="320.1">
                        ...
                        <Text color="black" fill="green" fontWeight={"500"} fontSize="12" x="249.25" y="360.1">
                    ...
                    <G>
                        ...
                        <Text color="black" fill="purple" fontWeight={"500"} fontSize="12" x="285.25" y="305.1">
                    ...
                    <G x="70" y="-60">
                        ...
                        <Text color="black" fill="orange" fontWeight={"500"} fontSize="12"  x="245.25" y="350.1">
                    ...
                    <G x="0" y="-125">
                        ...
                        <Text color="black" fill="red" fontWeight={"500"} fontSize="12" x="240.25" y="350.1">
                    ...
                    <G x="70" y="-215">
                        ...
                        <Text color="black" fill="green" fontWeight={"500"} fontSize="12" x="235.25" y="275.1">
                    ...
                    <G x="5" y="-235">
                        ...
                        <Text color="black" fill="red" fontWeight={"500"} fontSize="12" x="219.25" y="287.1">
