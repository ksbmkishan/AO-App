...
const DreshkanChart = ({ basicDetails, dispatch, DreshkanChart , isLoading }) => {

    console.log("arpit", DreshkanChart)
    ...
    useEffect(() => {
        ...
        dispatch(KundliActions.getDreshkanChart(payload))
    }, [dispatch])

   if (isLoading || !DreshkanChart) {
              return <Loader />;
          }
...
const mapStateToProps = state => ({
    ...
    DreshkanChart: state.kundli.DreshkanChart,
...
export default connect(mapStateToProps, mapDispatchToProps)(DreshkanChart);
