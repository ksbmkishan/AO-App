...
const LandLineBillPage = ({ route, dispatch, rechargeRequestFields, rechargeBanner }) => {
            ...
            requestPermission().then((hasPermission) => {
                if (hasPermission) {
                    const payload = {
                        ...
                        onComplete: () => navigation.navigate('LandLinePayment', {
                            providerData: {
                                number: accountNumber,
                    ...
                    console.log('CheckPayloadForLandline:::', payload);
    ...
    return (
        <View style={{ flex: 1, backgroundColor: 'white' }}>
            <MyHeader title={'Landline Bill Payment'} tintColor={Colors?.white} navigation={navigation} color='#002E6E'/>
            <MyLoader />
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={{ flex: 1, padding: Sizes.fixPadding }}>
                    ...
                    {/* Operator Info */}
                    <TouchableOpacity style={styles.inputWrapper} onPress={() => navigation.navigate('LandLineProviders')}>
...
export default connect(mapStateToProps, mapDispatchToProps)(LandLineBillPage);
