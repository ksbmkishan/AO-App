...
const GasPipedAmount = ({ route, customerData, dispatch, billInfo, navigation }) => {
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            ...
            <MyHeader title={'Gas Piped Bill'} tintColor={Colors.white} navigation={navigation} color='#002E6E'/>
...
export default connect(mapStateToProps, mapDispatchToProps)(GasPipedAmount);
