...
const GasPiped = ({ dispatch, allServiceProviders,rechargeBanner }) => {
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity
      activeOpacity={0.8}
      onPress={() => navigation.navigate('GasPipedOperators', { providerData: item })}
  ...
  return (
    <View style={{ flex: 1, backgroundColor: Colors.white }}>
      ...
      {/* <MyLoader /> */}
      <MyHeader title={'Gas Piped Operators'} tintColor={Colors.white} navigation={navigation} color='#002E6E' />
...
export default connect(mapStateToProps)(GasPiped);
