...
const Gas = ({ dispatch, gasOperatorData, dthCircleData, route, rechargeRequestFields, navigation, billInfo, rechargeBanner }) => {
            ...
            requestPermission().then((hasPermission) => {
                ...
                if (hasPermission) {
                    ...
                    const payload = {
                        ...
                        onComplete: () => navigation.navigate('GasAmount', { providerData: { number, product_name: providerData?.product_name, product_code: providerData?.product_code } }),
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: Colors.white }}>
            ...
            {/* <MyLoader /> */}
            <MyHeader title={'Book Cylinder'} tintColor={Colors.white} navigation={navigation} color='#002E6E'/>
