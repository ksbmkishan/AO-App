...
// import defaultOperatorImg from '../../../assets/tatasky.png';
import { Colors, Fonts, Sizes } from '../../../assets/style';
import { SCREEN_WIDTH } from '../../../config/Screen';
import MyStatusBar from '../../../components/MyStatusbar';
import MyHeader from '../../../components/MyHeader';

const HeavyRefresh = ({ dispatch, dthOperatorData }) => {
    ...
    return (
        <SafeAreaView style={styles.safeAreaView}>
            ...
            <MyHeader title={'Heavy Refresh'} tintColor={Colors.white} navigation={navigation} color='#002E6E'/>
                        ...
                        <Image
                            source={
                                imgError || !item?.operatorImage
                                    ? require('../../../assets/images/tatasky.png')
            ...
            <View style={styles.bottomContainer}>
                ...
                <View style={styles.inputRow}>
                    <View style={styles.iconContainer}>
                        <FontAwesome6 name="computer" size={20} color={'white'} />
                    </View>
                    <TextInput
                        maxLength={10}
...
export default connect(mapStateToProps, mapDispatchToProps)(HeavyRefresh);
