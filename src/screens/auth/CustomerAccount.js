...
const CustomerAccount = props => {
  ...
  const validation1 = () => {
    if (profileImage === 'https://api.astroone.in/uploads/customerImage/user_default.jpg') {
            ...
            <View
              ...
              <TouchableOpacity
                ...
                /> */}
                 ...
                 {profileImage && profileImage != 'https://api.astroone.in/uploads/' ? (
                            <Image
                            source={{ uri: profileImage }}
                            style={{
                              width: width * 0.4,
                            ...
                            <Image
                              source={require('../../assets/images/avatar_book.png')}
                              style={{
                                width: width * 0.4,
                                height: width * 0.4,
                                borderRadius: 100,
