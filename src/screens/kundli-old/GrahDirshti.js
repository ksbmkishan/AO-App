...
const GrahDirshti = ({ dispatch, drishti, route }) => {

    useEffect(() => {
        dispatch(KundliActions.getKundliDrishti('grah'));
    }, [route?.params, dispatch]);
    console.log('CheckDrishtiData:::KKK', drishti)
...
export default connect(mapStateToProps, mapDispatchToProps)(GrahDirshti)
