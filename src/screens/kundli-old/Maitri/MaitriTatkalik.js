...
const MaitriTatkalik = ({ dispatch,maitriData, route }) => {
    useEffect(() => {
        dispatch(KundliActions.getKundliMaitri('tatkalik'));
    }, [dispatch,route.params]);

    console.log('CheckKundliMaitriData:::KKK',maitriData)
...
export default connect(mapStateToProps, mapDispatchToProps)(MaitriTatkalik);
