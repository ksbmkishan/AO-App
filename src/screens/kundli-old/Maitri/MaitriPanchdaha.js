...
const MaitriPanchdaha = ({ dispatch,maitriData,route }) => {
    useEffect(() => {
        dispatch(KundliActions.getKundliMaitri('panchdaha'));
...
export default connect(mapStateToProps, mapDispatchToProps)(MaitriPanchdaha);
