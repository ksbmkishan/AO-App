...
const Vedicjyoti = ({ navigation, route, dispatch, isLoading, basicDetails ,kundliId}) => {
    const { t } = useTranslation();
    const viewRef = useRef(null);

    const [show, setShow] = useState('showKundliCharts');
    
    console.log("kundliIdjyoti", route?.params?.kundliId)

    console.log("basicDetailsanujpal", basicDetails)
    ...
    function tabsInfo() {
        ...
        const tabs = [
            ...
            { key: 'showKundliPlanets', label: t('CALCULATIONS') },
            { key: 'Houses', label: t('HOUSE') },
            ...
            <View
                ...
                <View style={{ flex: 0.8 }}>
                    <Text allowFontScaling={false}
                        ...
                        SAPTRISHI VEDIC JYOTISHACHARYA
                    </Text>
                </View>
            </View>
        )
