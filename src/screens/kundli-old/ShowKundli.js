...
const ShowKundli = ({ navigation, route, dispatch, isLoading, basicDetails }) => {
  ...
  function tabsInfo() {
    ...
    const tabs = [
      ...
      { key: 'showKundliCharts', label: t('chart') },
      { key: 'showKundliPlanets', label: t('planets') },
      { key: 'Houses', label: t('Houses') },
      { key: 'Sade Sati', label: t('Sade Sati') },
      { key: 'Dirshti', label: t('Dirshti') },
      { key: 'Maitri', label: t('Maitri') },
      { key: 'showDashna', label: t('Dasha') },
