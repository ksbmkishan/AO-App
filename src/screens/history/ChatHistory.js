    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          <View style={{ marginLeft: Sizes.fixPadding }}>
            ...
            <Text style={{ ...Fonts.gray12RobotoMedium }}>
              <TranslateText title={item?.astrologerId?.gender} />
            </Text>
          </View>
        </View>
        <View style={{ marginTop: Sizes.fixPadding }}>
          ...
          <Text
            style={{ ...Fonts.gray14RobotoRegular, color: Colors.blackLight }}>
            {t("Chat Price")}: {showNumber(item?.chatPrice)}/min
          </Text>
          <Text
            style={{ ...Fonts.gray14RobotoRegular, color: Colors.blackLight }}>
            {t("Total Charge")}: {showNumber(item?.totalChatPrice)}
          </Text>
          <Text
            style={{ ...Fonts.gray14RobotoRegular, color: Colors.blackLight }}>
